...
parser.i.newSubParser:{[lang;opts;disabled] 
 ...
 model:.p.import[$[`~chklng;`spacy;sv[`]`spacy.lang,lang]][hsym$[`~chklng;`load;chklng]
  ...
  if[`spell in opts;sphun:.p.import[`spacy_hunspell]`:spaCyHunSpell;hunspell:0N!sphun[model;
  .p.tuple 0N!parser.i.spelldict string lang];0N!model[`:add_pipe]hunspell];  
 model}
